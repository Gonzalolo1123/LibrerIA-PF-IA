...
urlpatterns = [
    ...
    path('lista/<int:list_id>/item/<int:item_id>/seleccionar-sugerencia/', views.select_suggestion_for_item, name='select_suggestion_for_item'),
    # URL para editar un ítem específico de la lista
    path('lista/<int:list_id>/item/<int:item_id>/editar/', views.edit_shopping_list_item, name='edit_shopping_list_item'),
    # URL para eliminar un ítem
    path('lista/<int:list_id>/item/<int:item_id>/eliminar/', views.delete_shopping_list_item, name='delete_shopping_list_item'),
    # URL para agregar un nuevo ítem a una lista existente
    path('lista/<int:list_id>/agregar-item/', views.add_shopping_list_item, name='add_shopping_list_item'),
    ...
    # Vista para mostrar correos recibidos
    path('correos/recibidos/', views.correos_recibidos, name='correos_recibidos'),
    path('correos/eliminar/', views.eliminar_correo, name='eliminar_correo'),
] 